...
<html lang="<%= language%>">
    ...
    <body class="<%= theme.equals("dark") ? "dark-mode" : ""%>" data-theme="<%= theme%>">
        ...
        <div class="dashboard">
            <h2><%= language.equals("vi") ? "Bảng điều khiển Quản trị" : "Admin Dashboard"%></h2>
            <p><%= language.equals("vi") ? "Xin chào" : "Hello"%>, <%= ((com.mycompany.oceanichotel.models.User) session.getAttribute("user")).getUsername()%>!</p>
            <p><%= language.equals("vi") ? "Chào mừng đến với bảng điều khiển quản trị." : "Welcome to the admin dashboard."%></p>
