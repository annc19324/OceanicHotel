...
//                booking.setAdults(rs.getInt("adults"));      // Lấy adults từ DB
//                booking.setChildren(rs.getInt("children"));  // Lấy children từ DB
...
//            stmt.setInt(5, booking.getAdults());    // Lưu adults vào DB
//            stmt.setInt(6, booking.getChildren());  // Lưu children vào DB
