                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <table class="w-full text-left">
                                ...
                                <!-- Trong phần <tbody> của bảng Booking List -->
                                <tbody>
                                <c:forEach var="booking" items="${bookings}">
                                    ...
                                    <td class="py-2">
                                    <c:if test="${booking.status == 'Pending' && booking.canCancel}">
                                        <form action="<%= request.getContextPath() %>/user/bookings" method="post" onsubmit="return confirm('<%= language.equals("vi") ? "Bạn có chắc muốn hủy đặt phòng này không?" : "Are you sure you want to cancel this booking?" %>');">
