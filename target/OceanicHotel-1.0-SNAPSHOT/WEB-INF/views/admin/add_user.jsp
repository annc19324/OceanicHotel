...
<body class="<%= theme.equals("dark") ? "dark-mode" : ""%>" data-theme="<%= theme%>">
    <div class="admin-container">
        ...
        <div class="main-content">
            <form action="<%= request.getContextPath()%>/admin/users/add" method="POST" onsubmit="return validateForm()">
                ...
                <div class="form-group">
                    ...
                    <select id="role" name="role" required>
                        ...
                        <option value="receptionist"><%= language.equals("vi") ? "Lễ tân" : "Receptionist"%></option>
                    </select>
                </div>
                <div class="form-group">
